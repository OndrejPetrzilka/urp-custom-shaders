...
// No shadow
// No distortion
Shader "Universal Render Pipeline/Particles/Simple Lit Extra"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include_with_pragmas "Include/Particles/ParticlesSimpleLitForwardPass.hlsl"
            ENDHLSL
        }
    ...
    CustomEditor "ParticlesSimpleLitExtraShaderGUI"
}
